...
do (
  ...
  factory = () ->
    ...
    defineMethod = (proto, name, args...) ->
      ...
      throw new Error "Method #{name} already defined" unless "function" is typeof proto.methods?[name]
    ...
    protocol.define = (name, args...) ->
      doc = args.pop() if "string" is typeof args[0]
      new Protocol name, args, doc

    getArgs = (fn) ->
      throw new Error 'Not a function' unless fn is typeof 'function'
    ...
    protocol.extend = (proto, predicate, args...) ->
      ...
      for arg in args
        ...
        if 'object' is typeof predicate
          methods = extendObject proto, predicate.constructor, dispatcher
        else if 'function' is typeof predicate
          methods = extendFn proto, predicate, dispatcher
